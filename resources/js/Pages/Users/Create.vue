<template>
    <div class="subContent area-update">
        <div class="wrap">
            <div class="section-title type01">
                <h3 class="title">회원가입</h3>
                <p class="body">회원가입 후 모든 기능을 이용하세요.</p>
            </div>

            <form class="form type02" @submit.prevent="register">
                ...
                <div class="m-input-wrap type01">
                    <div class="m-input-text type01">
                        <input type="password" placeholder="비밀번호" v-model="form.password" autocomplete="off">
                ...
                <div class="m-input-wrap type01">
                    <div class="m-input-text type01">
                        <input type="password" placeholder="비밀번호 확인" v-model="form.password_confirmation" autocomplete="off">
                        <p class="m-input-error" v-if="form.errors.password_confirmation">{{ form.errors.password_confirmation }}</p>
                    </div>
                </div>
                ...
                <button class="m-btn type01 bg-primary width-100">회원가입</button>
            </form>
        </div>
    </div>
